...
# recreating the Earned Run Average column
# divide the total number of earned runs allowed by the number of innings pitched
# multiply by 9
...
# removing rows with infinite ERA values, these make up less than 0.5% of rows
#Pitching <- Pitching[!(Pitching$ERA == Inf),]
